...
export default function SocialPreview({platform, body, title = '', visual, brandName = 'LABRIKA', views}: SocialPreviewProps) {
  ...
  if (platform === 'telegram') return <article {...shellProps}>
