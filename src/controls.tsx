...
function Popover({anchor,children,onClose,className='',width}: {anchor:RefObject<HTMLButtonElement|null>;children:ReactNode;onClose:()=>void;className?:string;width?:number}) {
